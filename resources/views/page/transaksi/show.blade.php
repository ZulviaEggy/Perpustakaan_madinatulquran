		...
		<div class="card">
			...
			<div class="card-body">
				...
				<ul class="media-list media-list-linked">
								<li class="media bg-light font-weight-semibold py-2">Data Peminjam Buku</li>
								<div class="media">
									<div class="mr-3">
										<a href="#">
										@if($pinjam->photo != NULL)
                                            <img class="rounded-circle" src="{{ url('/photo/siswa/'.$pinjam->photo) }}" width="80" alt="" style="margin-right:20px">
                                        @elseif($pinjam->photo == NULL)
                                            <img class="rounded-circle" src="{{asset('/global_assets')}}/images/placeholders/people.png" width="80"  alt="" style="margin-right:20px">
                                        @endif										
										</a>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div type="text" class="form-control">Siswa</div>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Nama Peminjam:</label>
										<div class="col-lg-6">
											<div type="text" class="form-control">{{ $pinjam->nama_siswa }}</div>
										</div>
									</div>
									@else
									<div class="form-group row">
									...
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Status:</label>
										<div class="col-lg-6">
											<div type="text" class="form-control">Guru</div>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Nama peminjam:</label>
										<div class="col-lg-6">
											<div type="text" class="form-control">{{ $pinjam->nama_lengkap }}</div>
										</div>
									</div>
									@endif
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-3">
										<div type="text" class="form-control">{{ $denda }}.00</div>
									</div>
								</div>
							
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Denda Buku:</label>
									<div class="col-lg-3">
										@if($pinjam->denda_buku == '')
										<div type="text" class="form-control">0.00</div>
										@else
										<div type="text" class="form-control">{{ $pinjam->denda_buku }}</div>
										@endif
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-3">
										<div type="text" class="form-control">{{ $denda + $pinjam->denda_buku }}.00</div>
									</div>
								</div>
