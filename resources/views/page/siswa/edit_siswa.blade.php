			...
			<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
				<div class="d-flex">
					<div class="breadcrumb">
						...
						<span class="breadcrumb-item active">Edit Siswa</span>
					</div>
					...
					<h5 class="card-title">Ubah profil</h5>
						<div class="container">
									...
									<div class="col-lg-9">
										<div class="form-check form-check-inline">
                                            <label class="form-check-label" for="gender" >
												<input type="radio" class="form-input-styled" name="gender" value="L" id="gender" {{$siswa->gender == 'L' ? 'checked' : ''}}>
												Laki-laki
											</label>
										</div>
										<div class="form-check form-check-inline">
											<label class="form-check-label" for="gender" >
											<input type="radio" class="form-input-styled" name="gender" value="P" id="gender"  {{$siswa->gender == 'P' ? 'checked' : ''}}>
												Perempuan
											</label>
										</div>
									</div>
                            ...
                            <div class="form-group row{{ $errors->has('no_telp') ? ' has-error' : '' }}">
								<label class="col-form-label col-lg-3">No telepon:<span class="text-danger"></span></label>
									<div class="col-lg-9">
										<input type="number" class="form-control" value="{{ $siswa->no_telp}}" name="no_telp" placeholder="Masukkan nomor telepon">										
							...
							<div class="form-group row{{ $errors->has('tahun_angkatan') ? ' has-error' : '' }}">
								<label class="col-lg-3 col-form-label">Tahun Angkatan:<span class="text-danger"></span></label>
									<div class="col-lg-9">
										<input class="form-control" type="text" placeholder="Tahun angkatan" name="tahun_angkatan" value=" {{ $siswa->tahun_angkatan }} " >
							...
							<div class="form-group row {{ $errors->has('kelas') ? ' has-error' : '' }}">
		                        <label class="col-form-label col-lg-3">Jenjang Pendidikan</label>
		                        	<div class="col-lg-4">
                                    	<select class="form-control form-control-uniform" name="kelas" required="">
