                    ...
                    <table width ="100%" style="font-size: 100%" class="text-left">
                      	<tr >
                        	<th rowspan="5" width="20%" style="padding:0px;" >
								@if($siswa->photo != NULL)
								<img width="60" height="60" id="viewfoto" src="{{public_path('/photo/siswa/'.$siswa->photo)}}" class="img-thumbnail fview" alt="Foto Anggota">
						...
						<tr>
							<td style="padding-left:12px"><b>NIS<b></td>
							<th width="1%">:</th>
							<td>{{ $siswa->NIS }}</td>
						</tr> 
						<tr>
						...
						<tr>
							<td style="padding-left:12px"><b>Tahun Angkatan<b></td>
							<th width="1%">:</th>
							<td>{{ $siswa->tahun_angkatan }}</td>
						</tr>
                	</table>
					<img style="padding-top:5px;padding-left:50px;font-size: 100%" src="data:image/png;base64,{{DNS1D::getBarcodePNG("$siswa->NIS", 'C128',1,38,array(1,1,1), true)}}" alt="barcode" />
            	</div>
			</div>
			</th>
