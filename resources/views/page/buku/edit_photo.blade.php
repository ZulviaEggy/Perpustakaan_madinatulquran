			...
			<div class="content">
               ...
               <!-- Basic layout-->
							...
							<div class="card-body">
								...
								<form method="post" action="{{ route('usulan.user', $usulan->id) }}" enctype="multipart/form-data">
								@csrf
								@method('PUT')
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Status Usulan</h5>
                                        </div>
                                        <div class="modal-body">
											<div class="form-group row" style="padding-left:5px">
												<label class="col-lg-2 col-form-label" for="print_qty">Status usulan:</label>
												<div class="col-lg-5">   
