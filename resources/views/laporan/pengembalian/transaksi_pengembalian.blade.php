				...
				<div class="d-flex">
					<div class="breadcrumb">
						...
						<a href="{{ url('/laporan/transaksi') }}" class="breadcrumb-item">Transaksi</a>
							<span class="breadcrumb-item active">Laporan pengembalian</span>
					</div>
			...
			<div class="col-lg-12 grid-margin stretch-card">
				<div class="card">
                	<div class="card-body header-elements-inline">
                  	<h4 class="card-title">Laporan Transaksi Pengembalian</h4>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
										...
										<div class="modal-body">
											<form action="{{ route('report.pengembalian') }}" method="get" target="_blank">
											<div class="form-group row">
											<h6 class="font-weight-semibold" style="padding-left:13px">Masukkan tanggal</h6>
												<div class="col-lg-12">
													<input type="text" id="created_at" name="date" class="form-control">                                </div>
													</input>
												</div>
											</div>
						...
						<div class="modal fade" id="ExcelModal" tabindex="-1" role="dialog">
							<div class="modal-dialog" role="document">
								<div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
									...
									<div class="modal-body">
									<form action="{{ route('report.pengembalianExcel') }}" method="get" target="_blank">
										<div class="form-group row">
										<h6 class="font-weight-semibold" style="padding-left:13px">Masukkan tanggal</h6>
											<div class="col-lg-12">
    ...
    $(document).ready(function() {
        ...
        let end = moment().endOf('month')
          ...
          //Export PDF diset URL berdasarkan tanggal tersebut
            $('#exportpdf').attr('href', '/transaksi/pengembalian/pdf/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
            ...
            $('#created_at').daterangepicker({
                ...
                $('#exportpdf').attr('href', '/transaksi/pengembalian/pdf/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
</script>
<script>
    ...
    $(document).ready(function() {
        ...
        let end = moment().endOf('month')
            ...
            //Export PDF diset URL berdasarkan tanggal tersebut
            $('#exportexcel').attr('href', '/laporan/trs/excel_pengembalian/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
           ...
           //Inisiasi daterangepicker
            $('#date').daterangepicker({
                ...
                endDate: end
                 ...
                 //Jika user mengubah value, manipulasi link dari export pdf
                $('#exportexcel').attr('href', '/laporan/trs/excel_pengembalian/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
</script>
