							...
							<div class="text-right">
								<div class="btn-group dropdown">
									...
									<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
										...
										<a class="dropdown-item" href="" data-toggle="modal" data-target="#kolModal"> Filter Tanggal</a>
										<a class="dropdown-item" href="{{ url('/laporan/trs/pdfTerlambat') }}"> Laporan Keterlambatan</a>
									</div>
								</div>
								<div class="btn-group dropdown">			
									...
									<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
										<a class="dropdown-item" href="{{ url('laporan/trs/excel') }}"> Semua Peminjaman</a>
										<a class="dropdown-item" href="" data-toggle="modal" data-target="#ExcelModal"> Filter Tanggal</a>
										<a class="dropdown-item" href="{{ url('/laporan/trs/excelKeterlambatan') }}"> Laporan Keterlambatan</a>
									</div>
								</div>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
											...
											<div class="modal-body">
												<form action="{{ route('report.transaksi1') }}" method="get" target="_blank">
													<div class="form-group row">
													<h6 class="font-weight-semibold" style="padding-left:10px">Masukkan tanggal:</h6>
														<div class="col-lg-12">
							...
							<div class="modal fade" id="ExcelModal" tabindex="-1" role="dialog">
								<div class="modal-dialog" role="document">
									<div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
										...
										<div class="modal-body">
											<form action="{{ route('report.Excel') }}" method="get" target="_blank">
												<div class="form-group row">
												<h6 class="font-weight-semibold" style="padding-left:10px">Masukkan tanggal:</h6>
														<div class="col-lg-12">
...
<!-- /page content -->
	<script>
        ...
        $(document).ready(function() {
            ...
            $('#exportpdf').attr('href', '/transaksi/pdf/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
           ...
           //Inisiasi daterangepicker
            $('#created_at').daterangepicker({
               ...
               //Jika user mengubah value, manipulasi link dari export pdf
                $('#exportpdf').attr('href', '/transaksi/pdf/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
	 <script>
        ...
        $(document).ready(function() {
           ...
           //Export PDF diset URL berdasarkan tanggal tersebut
            $('#exportexcel').attr('href', '/laporan/trs/excel/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
            ...
            $('#date').daterangepicker({
                ...
                endDate: end
                  ...
                  //Jika user mengubah value, manipulasi link dari export pdf
                $('#exportexcel').attr('href', '/laporan/trs/excel/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
