			...
			<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
				<div class="d-flex">
					<div class="breadcrumb">
						...
						<span class="breadcrumb-item active">Laporan peminjaman</span>
					</div>
			...
			<div class="col-lg-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body header-elements-inline">
						<h4 class="card-title">Laporan Transaksi Peminjaman</h4>
							<div class="text-right">
								...
								<!-- <div class="btn-group dropdown">
									...
									<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
										<a class="dropdown-item" href="{{ url('laporan/trs/pdf_peminjaman') }}"> Semua Peminjaman</a>
								...
								<div class="btn-group dropdown">			
									...
									<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
										<a class="dropdown-item" href="{{ url('laporan/trs/excel_peminjaman') }}"> Semua Peminjaman</a>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
											...
											<div class="modal-body">
												<form action="{{ route('report.order') }}" method="get" target="_blank">
							...
							<div class="modal fade" id="ExcelModal" tabindex="-1" role="dialog">
									<div class="modal-dialog" role="document">
										<div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
											...
											<div class="modal-body">
												<form action="{{ route('report.peminjamanExcel') }}" method="get" target="_blank">
													<div class="form-group row">
													<h6 class="font-weight-semibold" style="padding-left:13px">Masukkan tanggal</h6>
															<div class="col-lg-12">
...
<!-- /page content -->
  ...
  <script>
        ...
        $(document).ready(function() {
           ...
           //Export PDF diset URL berdasarkan tanggal tersebut
            $('#exportexcel').attr('href', '/laporan/trs/excel_peminjaman/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
            ...
            $('#date').daterangepicker({
                ...
                endDate: end
                  ...
                  //Jika user mengubah value, manipulasi link dari export pdf
                $('#exportexcel').attr('href', '/laporan/trs/excel_peminjaman/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
