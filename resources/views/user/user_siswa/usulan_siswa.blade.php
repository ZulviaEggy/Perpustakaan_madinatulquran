			...
			<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
				<div class="d-flex">
					<div class="breadcrumb">
						...
						<a href="{{ url('/usulan_siswa') }}" class="breadcrumb-item">List usulan</a>
		...
		<div class="content">
			...
			<div class="card">
               ...
               <!-- Basic layout-->
				...
				<div class="card-body">
                <form method="POST" action="{{ route('usulanSiswa.store') }}" enctype="multipart/form-data">
                @csrf
					<div class="form-group row">
						<label class="col-lg-3 col-form-label">NIS:</label>
						<div class="col-lg-9">
							<input class="form-control" type="text" name="nis" value="{{Auth::user()->siswa->NIS}}" required readonly="">
						</div>
					</div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-lg-9">
							<input class="form-control" type="text" name="nama" value="{{Auth::user()->siswa->nama_siswa}}" required readonly="">
						</div>
					</div>
					...
					<div class="text-right">
						...
						<a href="{{ route('usulan.siswa') }}"  class="btn btn-danger col-lg-1 ml-1">Kembali</a>
					</div>	
				</form>
				</div>
			</div>
