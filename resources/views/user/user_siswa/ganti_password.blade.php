	...
	<div class="content-wrapper">
		...
		<div class="content">
			...
			<div class="card">
				...
				<div class="card-body">
                <form method="POST" action="{{ route('changeSiswa.password') }}" enctype="multipart/form-data">
                @csrf
                ...
                @endforeach  -->
						...
						<div class="text-right">
                            <button class="btn btn-success col-lg-2 ml-1" type="submit" >Change Password</button>
						</div>
				</form>
				</div>
			</div>
